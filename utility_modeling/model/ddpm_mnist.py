...
#反向预测，对于输入的x_t反向去噪noise
    ...
    @torch.no_grad()
    def sample(self, model, image_size, batch_size=8, channels=3,timesteps=1000):
        # sample new images
        return self.p_sample_loop(model, shape=(batch_size, channels, image_size, image_size), timesteps=timesteps)
