...
def train_cifar10(
    device: str = "cuda:3", 
    ckpt_load_pth: str = 'checkpoint/cifar/ckpt_cplx100_.pt', 
    # ckpt_load_pth: str = "",
    ...
    matrix_file = os.path.join(matrix_dir_pth,'cifar10_cplx.txt')
    for e in range(n_epoch):
        ...
        if e % 5 == 0:
            ckpt_file = os.path.join(ckpt_dir_pth,"ckpt_cplx" + str(e) + "_.pt")
...
def eval_cifar10(
    ...
    ckpt_load_pth: str = "checkpoint/cifar/ckpt_cplx200_.pt",
    ckpt_dir_pth: str = "checkpoint/cifar/",
    matrix_dir_pth : str = "matrix/cifar/",
    sample_dir_pth : str = "sample/cifar/",
    log_dir_pth : str = "log/cifar/",
    ...
    with torch.no_grad():
        ...
        sample_file = os.path.join(sample_dir_pth,f"ddpm_sample_cifar_cplx{epoch}.png")
