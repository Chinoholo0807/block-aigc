...
def main(args=get_args()):
    ...
    args.state_shape = args.state_shape[0] if isinstance(args.state_shape, tuple) else args.state_shape
    args.action_shape = env.action_space.shape or env.action_space.n
    args.action_shape = args.action_shape[0] if isinstance(args.action_shape, tuple) else args.action_shape
    args.max_action = 1.
